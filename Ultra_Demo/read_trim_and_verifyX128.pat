...
cycle_delay(bg_setup1, 0x3E6, PSTeq0_stateX128)
//PORSTN = 1, delay = 401 cycle  20005ns
cycle_delay(bg_setup2, 0x4E23, PSTeq1_stateX128)
serial_test_mode_entryX128(enter_serial_testmode)
cycle_delay(delay2, 0x4e1e, stb_active_stateX128)
